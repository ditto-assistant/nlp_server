...
class NLP:
    ...
    def contruct_sentence_vectors(self):
        ...
        if self.train:
            ...
            # save
            joblib.dump(self.mlp_max_iter_model_cat, "models/mlp_max_iter_model_cat.pkl")
            joblib.dump(self.mlp_max_iter_model_subcat, "models/mlp_max_iter_model_subcat.pkl")
            joblib.dump(self.mlp_max_iter_model_action, "models/mlp_max_iter_model_action.pkl")
